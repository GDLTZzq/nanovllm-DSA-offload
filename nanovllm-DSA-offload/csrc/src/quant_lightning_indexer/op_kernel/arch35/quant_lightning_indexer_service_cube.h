...
public:
    ...
    // =================================================================================
    // [QuantLI vs LI 差异点 #11] Cube对齐单位和动态S2块
    // =================================================================================
    // LI: FP16_BLOCK_CUBE = 16            ← bf16/fp16 Cube对齐到 16B
    // QuantLI: FP8_BLOCK_CUBE = 32        ← int8/fp8 Cube对齐到 32B
    //
    // S2基本块:
    //   LI:   S2_BASIC_BLOCK = 128 固定
    //   QuantLI: s2BasicBlock_ 动态 = tSize≤256 ? 256 : 128
    //           (L122: InitParams中根据tSize切换)
    //           keyBufferOffset_ = s2BasicBlock_ * D_BASIC_BLOCK
    //           → 当tSize小时用256摊薄key搬运开销
    // =================================================================================
